...
struct __TestBlockStructViewController__testBlockCaptureStackVariable_block_impl_0 {
  ...
  int intTemp;
  __TestBlockStructViewController__testBlockCaptureStackVariable_block_impl_0(void *fp, struct __TestBlockStructViewController__testBlockCaptureStackVariable_block_desc_0 *desc, int _intTemp, int flags=0) : intTemp(_intTemp) {
...
( struct __TestBlockStructViewController__testBlockCaptureStackVariable_block_impl_0 *__cself ) {
  int intTemp = __cself->intTemp; // bound by copy
        NSLog((NSString *)&__NSConstantStringImpl__var_folders_fq_0xg0m16d4vdcxmvknssvd_h40000gn_T_TestBlockStructViewController_c9fdaa_mi_0, intTemp);
}
...
static void __TestBlockStructViewController__testBlockCaptureStackVariable_block_func_1
(struct __TestBlockStructViewController__testBlockCaptureStackVariable_block_impl_1 *__cself)
{
  __Block_byref_intBlock_0 *intBlock = __cself->intBlock; // bound by ref

        NSLog((NSString *)&__NSConstantStringImpl__var_folders_fq_0xg0m16d4vdcxmvknssvd_h40000gn_T_TestBlockStructViewController_c9fdaa_mi_1, (intBlock->__forwarding->intBlock));
}
...
static void _I_TestBlockStructViewController_testBlockCaptureStackVariable(TestBlockStructViewController * self, SEL _cmd) {
    ...
    (
        (id)self, sel_registerName("setBlock:"),
        (
    ...
    ((dispatch_block_t (*)(id, SEL))(void *)objc_msgSend) (
                                                           (id)self,
                                                           sel_registerName("block")
                                                           )();
    ...
    ((void (*)(id, SEL, dispatch_block_t))(void *)objc_msgSend)
    (
        (id)self, sel_registerName("setBlockVariable:"),
        (
            ...
            (
                ...
                (__Block_byref_intBlock_0 *)&intBlock, 570425344
            )
        )
     );
...
static void _I_TestBlockStructViewController_setBlock_(TestBlockStructViewController * self,
                                                       SEL _cmd,
                                                       dispatch_block_t block)
{
    objc_setProperty (self, _cmd, __OFFSETOFIVAR__(struct TestBlockStructViewController, _block), (id)block, 0, 1);
